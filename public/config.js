System.config({
  ...
  map: {
    ...
    "package.json": "npm:package.json@1.0.2",
    ...
    "npm:exec-limiter@3.2.3": {
      "child_process": "github:jspm/nodelibs-child_process@0.1.0",
      "limit-it": "npm:limit-it@3.2.3",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "typpy": "npm:typpy@2.3.3"
    },
    ...
    "npm:git-package-json@1.4.2": {
      "deffy": "npm:deffy@2.2.2",
      "err": "npm:err@1.1.1",
      "gry": "npm:gry@5.0.2",
      "normalize-package-data": "npm:normalize-package-data@2.3.5",
      "oargv": "npm:oargv@3.4.3",
      "one-by-one": "npm:one-by-one@3.2.1",
      "r-json": "npm:r-json@1.2.3",
      "r-package-json": "npm:r-package-json@1.0.1",
      "tmp": "npm:tmp@0.0.28"
    },
    "npm:git-source@1.1.2": {
      "git-url-parse": "npm:git-url-parse@5.0.1"
    },
    "npm:git-up@1.2.1": {
      "is-ssh": "npm:is-ssh@1.3.0",
      "parse-url": "npm:parse-url@1.3.3"
    },
    "npm:git-url-parse@5.0.1": {
      "git-up": "npm:git-up@1.2.1"
    },
    "npm:got@5.6.0": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
    ...
    "npm:gry@5.0.2": {
      "abs": "npm:abs@1.3.4",
      "exec-limiter": "npm:exec-limiter@3.2.3",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "one-by-one": "npm:one-by-one@3.2.1",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "ul": "npm:ul@5.2.2"
    ...
    "npm:oargv@3.4.3": {
      "iterate-object": "npm:iterate-object@1.3.2",
      "ul": "npm:ul@5.2.2"
    },
    "npm:obj-def@1.0.1": {
      "deffy": "npm:deffy@2.2.2"
    },
    "npm:one-by-one@3.2.1": {
      "obj-def": "npm:obj-def@1.0.1",
    ...
    "npm:package.json@1.0.2": {
      "git-package-json": "npm:git-package-json@1.4.2",
      "git-source": "npm:git-source@1.1.2",
    ...
    "npm:r-package-json@1.0.1": {
      "package-json-path": "npm:package-json-path@1.0.2",
      "r-json": "npm:r-json@1.2.3"
    },
    ...
    "npm:ul@5.2.2": {
      "deffy": "npm:deffy@2.0.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "typpy": "npm:typpy@2.0.0"
    },
